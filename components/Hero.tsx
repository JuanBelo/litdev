...
export function Hero() {
  return (
    <section
      ...
      className="lg:h-[calc(100vh] h-[calc(100vh)]"
    >
      <Logo />
      <div className="absolute h-full w-full flex justify-center items-center z-50 px-8">
        <div className="flex justify-center w-full flex-col items-center">
          <h4 className="mb-4 font-light text-brand-litdev-500">💡 Hey Devs</h4>
          <div className="block mb-5 lg:mb-3 lg:flex HeroTitle font-black md:text-5xl text-4xl">
            <span className="mb-4 ">
          ...
          <div className="flex justify-center items-center">
            <h6 className=" mb-8 text-xl md:text-2xl text-brand-litdev-700 tracking-wide text-center">
